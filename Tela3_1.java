...
public class Tela3_1 {
	public static void main(String[] args) {

		System.out.println("Massa do Bolo: ");
		imprimeVetor(massaBolo());
		System.out.println("Recheio e Cobertura: leite ninho com morangos");
		imprimeVetor(recheioNinho());
		System.out.println("Recheio e Cobertura: Dois amores");
		imprimeVetor(RecheioDoisAmores());
		System.out.println("Recheio e Cobertura: Maracujá");
	...
	public static String []recheioMaracuja ()
	{
		...
		maracuja[0]= "2 xícaras de suco de maracujá (240 ml)";
