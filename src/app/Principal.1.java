        ...
        for (int i = 0; i < vetorS1.length; i++) {
            switch (i) {
                ...
                case 2:
                    ...
                    System.out.printf("[%d] - %s:. . . . . . . . . . . . . .%03d   (un) . .R$ %.2f\n",
        ...
        for (int i = 0; i < vetorS1.length; i++) {
            switch (i) {
                ...
                case 2:
                    ...
                    System.out.printf("%s: . . . . . . . . . . . . . .%03d   (un) . .R$ %.2f\n",
            ...
            for (int i = 0; i < 8; i++) {
                switch (i) {
                    ...
                    case 2:
                        ...
                        System.out.printf("%s: . . . . . . . . . . . . . .%03d   (un) . .R$ %.2f\n",
                                vetorS1[2], (int) vetor1[2], valor1[2]);
                        break;
                    case 3:
                        System.out.printf("%s: . . . . . . . . . . . . . .%03d,%.0f (ml) . .R$ %.2f\n",
                                vetorS2[2], (int) vetor2[2], ((vetor2[2] - (int) vetor2[2]) * 100), valor2[2]);
                        break;
                    case 4:
                        System.out.printf("%s: . . . . . . . . . . . . .%03d,%.0f (g). . .R$ %.2f\n",
                                vetorS1[0], (int) vetor1[0], ((vetor1[0] - (int) vetor1[0]) * 100), valor1[0]);
                        break;
                    case 5:
                        System.out.printf("%s:. . . . . . . . . . . . . .%03d,%.0f (ml) . .R$ %.2f\n",
                                vetorS2[3], (int) vetor2[3], ((vetor2[3] - (int) vetor2[3]) * 100), valor2[3]);
                        break;
                    case 6:
                        System.out.printf("%s: . . . . . . . . . . . .%03d,%.0f (g). . .R$ %.2f\n",
                                vetorS2[4], (int) vetor2[4], ((vetor2[4] - (int) vetor2[4]) * 100), valor2[4]);
                        break;
                    case 7:
                        System.out.printf("%s: . . . . . . . . . . .%03d   (un) . .R$ %.2f\n",
                                vetorS2[5], (int) vetor2[5], valor2[5]);
                        break;
                    default:
                        break;
                }
            ...
            switch (validaNumeroInt()) {
                ...
                case 5:// Caso 5: Pede a QNT, VLR do Morango, Dois Amores ou Maracujá
                    ...
                    if (str1.equals("Maracujá")) {
                        ...
                        do {
                            System.out.printf("Informe o valor pago em %.1f mililitros de Maracujá: ", vetor2[0]);
                            valor2[0] = validaNumeroDoub();// Método Valida NumDouble: Atribui ao 1º elemento do vetorVLR um valor informado.(valor > 0)
                            if (valor2[0] < 0) {
                                System.out.printf("\nO valor informado é inválido!\n\n");
                            }
                ...
                case 6:// Caso 6: Pede a QNT, VLR do Morango, Dois Amores ou Maracujá
                    ...
                    if (str1.equals("Maracujá")) {
                        ...
                        do {
                            System.out.printf("Informe o valor pago em %.1f gramas de Amido de Milho: ", vetor2[1]);
                            valor2[1] = validaNumeroDoub();// Método Valida NumDouble: Atribui ao 1º elemento do vetorVLR um valor informado.(valor > 0)
                            if (valor2[1] < 0) {
                                System.out.printf("\nO valor informado é inválido!\n\n");
                            }
                ...
                case 7:// Caso 7: Pede a QNT, VLR do Morango, Dois Amores
                    ...
                    if (str1.equals("Maracujá")) {
                        do {
                            System.out.printf("Informe a quantidade de Água(ml): ");
                            vetor2[2] = validaNumeroDoub();// Método Valida NumDouble: Atribui ao 1º elemento do vetorQNT um valor informado.(valor >= 600) 
                            if (vetor2[2] < 250) {
                                System.out.printf("\n<<<A quantidade mínima de Água(ml)\npara uma receita é 250ml!>>>\n\n");
                            }
                        } while (vetor2[2] < 250);
                        do {
                            System.out.printf("Informe o valor pago em %.1f ml de Leite: ", vetor2[2]);
                            valor2[2] = validaNumeroDoub();// Método Valida NumDouble: Atribui ao 1º elemento do vetorVLR um valor informado.(valor > 0)
                            if (valor2[2] < 0) {
                                System.out.printf("\nO valor informado é inválido!\n\n");
                            }
                ...
                case 8:// Caso 8: Pede a QNT, VLR do Morango, Dois Amores
                    ...
                    if (str1.equals("Dois Amores")) {
                        do {
                            System.out.printf("Informe a quantidade de Pote(200ml): ");
                            ...
                            if (vetor2[3] < rendimento) {
                                System.out.printf("\n<<<         "
                                        + "A quantidade de Pote(200ml)\nnão pode ser menor que o rendimento da receita(%s)!>>>\n\n", rendimento);
                            }
                        } while (vetor2[3] < rendimento);
                        do {
                            System.out.printf("Informe o valor pago em %.0f unidades do Pote(200ml): ", vetor2[3]);
                    ...
                    if (str1.equals("Maracujá")) {
                        do {
                            System.out.printf("Informe a quantidade de Leite(ml): ");
                            vetor2[3] = validaNumeroDoub();// Método Valida NumDouble: Atribui ao 1º elemento do vetorQNT um valor informado.(valor >= 600) 
                            if (vetor2[3] < 200) {
                                System.out.printf("\n<<<A quantidade mínima de Leite(ml)\npara uma receita é 200ml!>>>\n\n");
                            }
                        } while (vetor2[3] < 200);
                        do {
                            System.out.printf("Informe o valor pago em %.1f ml de Leite: ", vetor2[3]);
                            valor2[3] = validaNumeroDoub();// Método Valida NumDouble: Atribui ao 1º elemento do vetorVLR um valor informado.(valor > 0)
                            if (valor2[3] < 0) {
                                System.out.printf("\nO valor informado é inválido!\n\n");
                            }
                ...
                case 9:
                    ...
                    if (str1.equals("Maracujá")) {
                        do {
                            System.out.printf("Informe a quantidade de Manteiga(g): ");
                            vetor2[4] = validaNumeroDoub();// Método Valida NumDouble: Atribui ao 1º elemento do vetorQNT um valor informado.(valor >= 600) 
                            if (vetor2[4] < 50) {
                                System.out.printf("\n<<<A quantidade mínima de Manteiga\npara uma receita é 01 colher (50 g cada)!>>>\n\n");
                            }
                        } while (vetor2[4] < 50);
                        do {
                            System.out.printf("Informe o valor pago em %.1f gramas de Maneteiga: ", vetor2[4]);
                    ...
                    if (str1.equals("Morango")) {
                        ...
                        do {
                            System.out.printf("Informe o valor pago em %.0f unidades do Pote(200ml): ", vetor2[4]);
                            valor2[4] = validaNumeroDoub();// Método Valida NumDouble: Atribui ao 1º elemento do vetorVLR um valor informado.(valor > 0)
                            if (valor2[4] < 0) {
                                System.out.printf("\nO valor informado é inválido!\n\n");
                            }
                ...
                case 10:
                    ...
                    do {
                        System.out.printf("Informe o valor pago em %.0f unidades do Pote(200ml): ", vetor2[5]);
            ...
            if (verifVetorCheio1 == 0 && verifVetorCheio2 == 0) {// if(vetores == Cheios)>> verificar os vetore
                if (str1.equals("Maracujá")) {// if(opcaoReceita == Maracujá)>>verivicar se a opcao bolo é maracujá
                    if (vetor1[0] < 500) {// if(QNTaçucar < ((200+300)=500))>> verificar se quantidade de açucar é menor do que 
                        ...
                        do {
                            System.out.printf("Informe novamente a quantidade de Açúcar(g): ");
                    ...
                    if (vetor1[2] < 10) {// if(QNTovo < ((04+06)=10))>> verificar se quantidade de ovos é menor do que
                        ...
                        do {
                            System.out.printf("Informe novamente a quantidade de Ovos: ");
